...
class Goomba extends __WEBPACK_IMPORTED_MODULE_0__entity__["a" /* default */] {
  constructor(img, xPos, yPos, width, height) {
    ...
    const self = this;
    this.squishSound = new Audio('/static/mario_js/assets/audio/sounds/stomp.wav');
...
class Mario extends __WEBPACK_IMPORTED_MODULE_0__entity__["a" /* default */] {
  constructor(img, xPos, yPos, width, height) {
    ...
    const self = this;
    this.jumpSound = new Audio('/static/mario_js/assets/audio/sounds/jump.wav');
    this.deathSound = new Audio('/static/mario_js/assets/audio/sounds/mario_death.wav');
    this.bumpSound = new Audio('/static/mario_js/assets/audio/sounds/bump.wav');
    this.powerupSound = new Audio('/static/mario_js/assets/audio/sounds/powerup.wav');
    this.powerdownSound = new Audio('/static/mario_js/assets/audio/sounds/powerdown.wav');
...
class MapBuilder {
  constructor(level, tileset, spriteSheet) {
    ...
    this.mountainSheet.src = '/static/mario_js/assets/sprites/mountain.png';
    this.cloudsSheet = new Image();
    this.cloudsSheet.src = '/static/mario_js/assets/sprites/clouds.png';
    this.castleSheet = new Image();
    this.castleSheet.src = '/static/mario_js/assets/sprites/castle.png';
...
class Block extends __WEBPACK_IMPORTED_MODULE_0__entity__["a" /* default */] {
  constructor(contents, tileset, xPos, yPos, width, height) {
    ...
    this.coinSound = new Audio('/static/mario_js/assets/audio/sounds/coin.wav');
    this.powerupSpawnSound = new Audio('/static/mario_js/assets/audio/sounds/powerup_spawn.wav');
  ...
  collectCoin(data) {
    ...
    data.entities.score.value += 50;
    console.log(data.entities.score.value)
    ...
    if (userIsAuthenticated === true) {
        $.ajax({
        url: hostPort + "super_mario_save_points/" + data.entities.score.value + "/",
        type: "POST",
        data: {
...
class Coin extends __WEBPACK_IMPORTED_MODULE_0__entity__["a" /* default */] {
  constructor(spriteSheet, xPos, yPos, width, height) {
    ...
    this.tileset.src = '/static/mario_js/assets/sprites/tileset_gutter.png';
